...
c_lib.getPlanCollider.restype = PLAN_COLLIDER
# WARNING : python parameter should be explicitly converted to proper c_type if not integer.
...
class ParticleUI :
    ...
    def addParticle(self, screen_pos, radius, mass) :
        ...
        draw_id = self.canvas.create_oval(0,0,0,0,fill="HotPink1")
